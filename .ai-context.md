...
// ✅ CORRECT (Next.js 15 - Client Component)
"use client"
...
### ⚠️ Client Component Requirements
...
### ⚠️ Registry-Based Content System
...
### ❌ DON'T: Create Individual Page Files

```typescript
// ❌ WRONG - Don't create this:
app/problems/my-new-problem/page.tsx

// ✅ CORRECT - Just update registry:
content/pages-registry.ts
```

### ❌ DON'T: Pass Registry Objects Directly
...
Need to add documentation?
  └─→ Update pages-registry.ts + nav.ts

Need to create a component?
  └─→ Does it use hooks or receive interactive props?
        ├─→ YES: Add "use client"
        └─→ NO: Leave as Server Component
...
Getting an error?
  └─→ Check ARCHITECTURE_PATTERNS.md Common Mistakes section
```
...
### January 15, 2026
- ✅ Added Client Component directives
- ✅ Fixed dynamic page rendering
- ✅ Updated setup checklist content
